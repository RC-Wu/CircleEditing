...
OUT_PATH = Path(__file__).resolve().parent / "manifests" / "20260413_wave18_gpu3_five_rounds.json"
...
METHODS = {
    "open_semboost_core": {
        "exp": {},
        "env": {},
        "notes": "anchor regime for carrier comparison",
    },
    "open_semboost_core_a_baseline": {
        ...
        "notes": "A-baseline warp/fuse residual carrier probe",
    },
    "open_semboost_core_blite": {
        ...
        "notes": "B-lite canonical carrier probe",
    },
}

JOB_SPECS = [
    ("bandage_wrap", "open_semboost_core"),
    ("bandage_wrap", "open_semboost_core_a_baseline"),
    ("bandage_wrap", "open_semboost_core_blite"),
    ("goldmask_structured", "open_semboost_core_a_baseline"),
        ...
        rows.append(
            {
                ...
                "exp_kwargs": {
                    **exp,
                    "notes": (
                        "wave18 gpu3 five-round queue: "
                        f"{method_cfg['notes']} for {prompt_cfg['notes']}"
                    ),
                },
                "extra_env": env,
            }
